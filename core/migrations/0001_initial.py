# Generated by Django 3.0.1 on 2020-01-01 20:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('TS', 'T-Shirt'), ('HO', 'Hoodie'), ('HA', 'Hat')], default='TS', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(choices=[('size', 'size'), ('style', 'style')], default='size', max_length=120)),
